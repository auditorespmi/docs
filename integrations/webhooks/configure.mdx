...
description: Configure webhooks to receive real-time events. Register an endpoint URL, choose event types, verify signatures, and test delivery with retries.
---
...
<Steps>
  ...
  <Step title="Select events">
    ...
    See the event types reference for the full list and payload schemas. {/* TODO: link to /integrations/webhooks/event-types once that page exists. */}
  </Step>
