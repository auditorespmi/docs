...
description: Define roles and permissions to control access across workspaces and projects. Assign built-in roles, build custom ones, and audit user privileges.
---
