...
description: Configure general workspace settings including organization name, timezone, locale, date formats, and display preferences for all team members.
---
