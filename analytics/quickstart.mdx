...
description: Get started with analytics by connecting a data source, building your first dashboard, and sharing insights with your team in under 15 minutes.
---
...
- Explore charts and visualizations to learn about all available chart types. {/* TODO: link to /analytics/dashboards/charts-visualizations once that page exists. */}
